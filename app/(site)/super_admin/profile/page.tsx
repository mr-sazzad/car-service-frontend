    ...
    <div className="container mx-auto min-h-[80vh] my-5">
      <div className="mx-4 md:mx-8 lg:mx-10">
        <div className="flex flex-col lg:flex-row gap-3 w-full min-h-[70vh]">
          <div className="bg-gray-100 w-full lg:w-[250px] rounded-md relative">
            <div className="flex flex-col gap-3 mb-10">
              <div className="flex flex-col gap-1">
                ...
                <div className="inline-flex justify-center ">
                  <p className="text-sm font-medium text-gray-200 bg-green-400 px-2 py-[2px] rounded-full">
                    @ {currentUser?.name}
                  </p>
                </div>
              </div>
              <div className="ml-5 lg:ml-3 flex flex-col gap-3">
                ...
                <p className="text-sm absolute bottom-5 lg:left-5 left-[40%]">
                  Logged In As{" "}
                  <span className="font-semibold">{currentUser?.role}</span>
                </p>
              </div>
              <div className="ml-5 lg:ml-3 flex flex-col gap-1 mt-auto">
                <p className="text-sm font-medium text-gray-500">Warning</p>
                <p className="text-sm font-medium text-gray-600">
                  Please Update Your Necessary fields
                </p>
              </div>
            </div>
          </div>
